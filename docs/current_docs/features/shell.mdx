...
Dagger Shell can load Dagger Modules, inspect their types, and run their functions. This works for both local and remote modules.
...
This works by executing the module's [constructor function](../extending/constructors.mdx). It works exactly like executing any other function:
