...
Once you have [completed the quickstart](../quickstart/index.mdx), and learned the basic concepts, it's time to take the next step: adopting Dagger in your project. We call this *daggerizing*. But how does one daggerize a project, exactly?
...
If you haven't already, make sure to [complete the Quickstart](../quickstart/index.mdx), which will teach you how to daggerize an example pipeline.
...
- Learn more about key Dagger concepts like [function chaining](../extending/index.mdx), [just-in-time artifacts](../extending/return-types.mdx), and [observability](../features/observability.mdx).
...
Once your pipeline is daggerized, and integrated in your development toolchain, it's time for the final step: [integrating it in CI](../using/integrations/ci.mdx).
...
4. Find the [integration page for your CI platform](../using/integrations/ci.mdx), and follow the instructions. For example: [GitHub](../using/integrations/github.mdx), [GitLab CI](../using/integrations/gitlab.mdx), [CircleCI](../using/integrations/circleci.mdx), [Jenkins](../using/integrations/jenkins.mdx), [Azure Pipelines](../using/integrations/azure-pipelines.mdx), [AWS CodeBuild](../using/integrations/aws-codebuild.mdx), [Argo Workflows](../using/integrations/argo-workflows.mdx) and [Tekton](../using/integrations/tekton.mdx).
