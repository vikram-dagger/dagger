...
<Tabs groupId="language" queryString="sdk">
<TabItem value="go" label="Go">
```go file=../extending/snippets/functions/functions-complex/go/main.go
```

This Dagger Function includes the context as input and error as return in its signature.
</TabItem>
<TabItem value="python" label="Python">
```python file=../extending/snippets/functions/functions-complex/python/main.py
```
...
<TabItem value="typescript" label="TypeScript">
```typescript file=../extending/snippets/functions/functions-complex/typescript/index.ts
```
</TabItem>
<TabItem value="php" label="PHP">
```php file=../extending/snippets/functions/functions-complex/php/src/MyModule.php
```
</TabItem>
<TabItem value="java" label="Java">
```java file=../extending/snippets/functions/functions-complex/java/src/main/java/io/dagger/modules/mymodule/MyModule.java
```
</TabItem>
</Tabs>
